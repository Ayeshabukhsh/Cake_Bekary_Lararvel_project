			...
			<div class="row">
				...
				<div class="col-lg-4 order-form-w3ls pl-lg-0" id="order">
					<div class="agile_its_registration bg-white">
						...
						<form method="POST" id="contactForm" action="{{route('index.store')}}" enctype="multipart/form-data">
						@csrf
				...
				<div  class=" text-light rounded-top p-5 my-6 mb-0 wow fadeInUp" data-wow-delay="0.1s"  style="background-color:#522c1b;">
					<div class="row align-items-center">
						...
						<div class="col-md-6 text-md-end">
							...
							<form action="https://formsubmit.co/ayeshabukhsh73@gmail.com" method="POST">
								<input type="hidden" name="_captcha" value="false">
								<input type="hidden" name="_next" value="http://127.0.0.1:8000/thanks">
								<input class="form-control bg-transparent border-light w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email"  name="email" required><br>
								<button type="submit" class="btn btn-dark py-2 px-3 position-absolute top-0 end-0 mt-2 me-2">Subscribe Your Email</button>
								</form>
